...
public class TelaAcaoProfessorInserir extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        aluno.setA1(Integer.parseInt(jTextField1.getText()));
        aluno.setA2(Integer.parseInt(jTextField3.getText()));
        aluno.setA3(Integer.parseInt(jTextField4.getText()));
        
        if (this.conexao != null) {
            Conexao.getConexaoMySQL();
        }
        
        this.Conexao.inserirNotas(jTextField1.getText(), jTextField3.getText(), jTextField4.getText());
        
        
        if(aluno.verificaNotas()){
            jLabel10.setText("Notas cadastradas!!");
        }else{
            jLabel11.setText("As notas nao foram inseridas");
        }
